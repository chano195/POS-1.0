    ...
    $(document).ready(function () {
        ...
        function loadCustomers() {
            ...
            $.get(api + 'customers/all', function (customers) {
                ...
                $('#customer').html(`<option value="0" selected="selected">Comprador ocasional</option>`);
            ...
            $.get(api + 'users/all', function (users) {
                ...
                users.forEach((user, index) => {
                    ...
                    if (user.status != "") {
                        ...
                        switch (state[0]) {
                            case 'Ingreso en': class_name = 'btn-default';
                                break;
                            case 'Cerró sesión en': class_name = 'btn-light';
                                break;
                        }
                    }
